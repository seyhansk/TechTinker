...
<body>
    ...
    <img src="resimler/set4.gif" alt="Banner3 Görseli" style="margin-top: 100px;">
    </div>
...
// Ürünleri sorgula
$sql = "SELECT id, product_name, price, img_url FROM shopping_cart WHERE category = 'elektronikkart'";
